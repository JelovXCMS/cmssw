...
config.General.requestName = 'Data_pp5TeV_HiForest75X_bjtJESdown_json'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../runForestAOD_pp_DATA_75X_bjtJESdown.py'
...
config.Data.outputDatasetTag = 'Data_pp5TeV_HiForest75X_bjtJESdown_json'
