...
options.register('mcGlobalTag', '75X_mcRun2_asymptotic_ppAt5TeV_v3',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "MC global tag"
)
#75X_mcRun2_HeavyIon_v13
options.register('dataGlobalTag', 'auto:run2_data', 
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "Data global tag"
)
...
pfCandidates = 'particleFlowTmp' #'particleFlow'
pvSource = 'hiSelectedVertex' #'offlinePrimaryVertices'
...
#        '/store/mc/RunIIFall15DR76/TTJets_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/AODSIM/PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/30000/00348C6E-599F-E511-B51D-02163E00F4BF.root'
				#'/store/himc/HINppWinter16DR/Pythia6_Dijet80_pp502/AODSIM/75X_mcRun2_asymptotic_ppAt5TeV_v3-v1/50000/3AE39D9D-7C10-E611-AB56-0025904CF712.root' #pp Dijet80
				'file:/home/peng43/work/EPR/2017_BTag/LTtag/JP_calibration/calibration_step1_BtagAnalyzerNtuple/ForPbPb/CMSSW_7_6_5/src/RecoBTag/PerformanceMeasurements/test/Pythia6_Dijet30_PbPb_testsample.root'
    )
)
if options.miniAOD:
...
if options.runOnData:
    process.source.fileNames = [
        '/store/data/Run2015E/HighPtJet80/AOD/PromptReco-v1/000/262/271/00000/E4A28FD7-3996-E511-A825-02163E01395B.root'
...
## default 76X calibration file, don't use for 75X 
...
## jp calibration method 2 , de-activate for provide original info
