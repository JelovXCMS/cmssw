...
config.General.requestName = 'Data_pp5TeV_HiForest75X_QCDJERgaus_json_t2'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../runForestAOD_pp_DATA_75X_QCDJERgaus.py'

config.Data.inputDataset = '/HighPtJet80/Run2015E-PromptReco-v1/RECO'
config.Data.inputDBS ='global'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 1
config.Data.outLFNDirBase = '/store/user/%s/HiForest75X_QCDJERgaus/' % (getUsernameFromSiteDB())
#config.Data.publication = True
config.Data.outputDatasetTag = 'Data_pp5TeV_HiForest75X_QCDJERgaus_json_t2'
