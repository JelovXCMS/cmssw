...
config.General.requestName = 'Data_pp5TeV_HiForest75X_QCDJESup_json_pt160'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../runForestAOD_pp_DATA_75X_QCDJESup.py'
...
config.Data.outputDatasetTag = 'Data_pp5TeV_HiForest75X_QCDJESup_json_pt160'
