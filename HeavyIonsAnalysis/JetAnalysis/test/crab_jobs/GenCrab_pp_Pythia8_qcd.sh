...
config.General.requestName = '${INFILENAME}_HiForest75X_JER20171221'
...
config.Data.outLFNDirBase = '/store/user/%s/HiForest75X_JER20171221/' % (getUsernameFromSiteDB())
#config.Data.publication = True
config.Data.outputDatasetTag = '${INFILENAME}_HiForest75X_JER20171221'
