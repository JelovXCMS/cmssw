...
options.register('mcGlobalTag', '75X_mcRun2_HeavyIon_v13',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "MC global tag"
)
options.register('dataGlobalTag', '75X_dataRun2_v13', 
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "Data global tag"
)
...
pfCandidates = 'particleFlowTmp' #pp particleFlow, 
pvSource = 'hiSelectedVertex' #pp : offlinePrimaryVertices , PbPb: 
...
## just for test 2017.11.13 , not work, no attribute "options"
...
#				  '/store/himc/HINppWinter16DR/Pythia6_bJet30_pp502/AODSIM/75X_mcRun2_asymptotic_ppAt5TeV_v3-v1/50000/144AAFF2-C20E-E611-9257-0025905D1CB0.root' # bjet30 pythia6 n48441
#				'/store/himc/HINppWinter16DR/Pythia6_Dijet50_pp502/AODSIM/75X_mcRun2_asymptotic_ppAt5TeV_v3-v1/30000/2C41CD20-520B-E611-9980-02163E011A01.root' #qcd jet50 pythia6 n48973
#'/store/himc/HINPbPbWinter16DR/Pythia6_Dijet30_pp502_Hydjet_MB/AODSIM/75X_mcRun2_HeavyIon_v13-v1/00000/00FDD68B-AC06-E611-88DC-00266CFACC38.root' #qcd30 pythia6 PbPb n2320
'file:Pythia6_Dijet30_PbPb_testsample.root'
    )
)
if options.miniAOD:
...
'/store/data/Run2015E/HighPtJet80/AOD/PromptReco-v1/000/262/163/00000/5CE8790A-E191-E511-A504-02163E0134D4.root' #5Tev pp reference 2015 
...
if options.runOnData :
    options.outFilename += '_data_ori'
else :
    options.outFilename += '_mc_ori'
...
options.outFilename += '_PbPb_JPCali.root'
...
## jp calibration method 2
from CondCore.DBCommon.CondDBSetup_cfi import *
process.jpTagConds = cms.ESSource("PoolDBESSource", CondDBSetup,
  connect = cms.string('sqlite_file:JPcali_75X_PbPb_mc_qcd30.xml.db'),
    toGet = cms.VPSet( # overide Global Tag use EcalTBWeights _EBEE_offline
        cms.PSet(
...
## test load full patHeavyIonsequeces 
#process.load("PhysicsTools.PatAlgos.producersLayer1.patCandidates_cff")
process.load("PhysicsTools.PatAlgos.producersHeavyIons.heavyIonPatCandidates_cff")
...
#    useRho = cms.bool(False)   ## temporary set to False, need to generate rho module later.
#)

## from RecoHI.HiJetAlgos.hiFJRhoProducer import hiFJRhoProducer
##then add "hiFJRhoProducer" to your sequence
##it will build this content by default: cms.InputTag('hiFJGridEmptyAreaCalculator','mapToRhoCorr1Bin')
...
process.btagana.storePatMuons         = False ## test to trun off muon
