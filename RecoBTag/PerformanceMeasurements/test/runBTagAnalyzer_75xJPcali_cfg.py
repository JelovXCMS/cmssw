...
if options.runOnData :
    options.outFilename += '_data_JPCali'
else :
    options.outFilename += '_mc_JPCali'
...
### default setting for 76x calibration ## should not use when running 75x 
...
## jp calibration method 1
## process.GlobalTag.toGet = cms.VPSet(
##     cms.PSet(record = cms.string("BTagTrackProbability3DRcd"),
##       tag = cms.string('probBTagPDF3D_tag_mc'),
##       connect = cms.string("sqlite_file:JPcalib_MC75X_ppbjt30.db")
##     )
## )
