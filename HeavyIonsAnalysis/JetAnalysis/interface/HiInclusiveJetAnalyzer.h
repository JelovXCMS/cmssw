...
class HiInclusiveJetAnalyzer : public edm::EDAnalyzer {
	...
	private:
		...
		bool useSubjets_;
		bool doGhostFlavorMatch_;
		//  bool doGhostSubJetFlavor_;
		...
		struct JRA{
			...
			// for Jet flavor ghost matching 
			int refFlavorID_jet_hadronID  [MAXJETS];
			float refFlavorID_jet_hadronPT[MAXJETS];
			float refFlavorID_jet_hadronEta[MAXJETS];
			float refFlavorID_jet_hadronPhi[MAXJETS];
			float refFlavorID_jet_hadronDR[MAXJETS];

			int refFlavorID_jet_partonID[MAXJETS];
			float refFlavorID_jet_partonPT[MAXJETS];
			float refFlavorID_jet_partonEta[MAXJETS];
			float refFlavorID_jet_partonPhi[MAXJETS];
			float refFlavorID_jet_partonDR[MAXJETS];

			int refFlavorID_Subjet1_hadronID[MAXJETS];
			float refFlavorID_Subjet1_hadronPT[MAXJETS];
			float refFlavorID_Subjet1_hadronEta[MAXJETS];
			float refFlavorID_Subjet1_hadronPhi[MAXJETS];
			float refFlavorID_Subjet1_hadronDR[MAXJETS];

			int refFlavorID_Subjet1_partonID[MAXJETS];
			float refFlavorID_Subjet1_partonPT[MAXJETS];
			float refFlavorID_Subjet1_partonEta[MAXJETS];
			float refFlavorID_Subjet1_partonPhi[MAXJETS];
			float refFlavorID_Subjet1_partonDR[MAXJETS];

			int refFlavorID_Subjet2_hadronID[MAXJETS];
			float refFlavorID_Subjet2_hadronPT[MAXJETS];
			float refFlavorID_Subjet2_hadronEta[MAXJETS];
			float refFlavorID_Subjet2_hadronPhi[MAXJETS];
			float refFlavorID_Subjet2_hadronDR[MAXJETS];

			int refFlavorID_Subjet2_partonID[MAXJETS];
			float refFlavorID_Subjet2_partonPT[MAXJETS];
			float refFlavorID_Subjet2_partonEta[MAXJETS];
			float refFlavorID_Subjet2_partonPhi[MAXJETS];
			float refFlavorID_Subjet2_partonDR   [MAXJETS];



			// end Jet flavor ghost matching
