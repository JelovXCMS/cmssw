...
config.General.requestName = 'Data_pp5TeV_HiForest75X_QCDJESup_json_t2'
...
config.Data.outLFNDirBase = '/store/user/%s/HiForest75X_QCDJESup/' % (getUsernameFromSiteDB())
#config.Data.publication = True
config.Data.outputDatasetTag = 'Data_pp5TeV_HiForest75X_QCDJESup_json_t2'
