...
config.General.requestName = 'Data_pp5TeV_HiForest75X_QCDJESdown_json_t3'
...
config.Data.outLFNDirBase = '/store/user/%s/HiForest75X_QCDJESdown/' % (getUsernameFromSiteDB())
#config.Data.publication = True
config.Data.outputDatasetTag = 'Data_pp5TeV_HiForest75X_QCDJESdown_json_t3'
